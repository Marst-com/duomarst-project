...
<header class="hero" style="padding-bottom:32px">
  <div class="container">
    <span class="hero-eyebrow">MY PAGE</span>
    <h1 id="welcomeMsg">불러오는 중...</h1>
    <p>로그인한 이메일로 신청한 예약 내역이에요.</p>
  </div>
</header>
...
<section style="padding-top:0">
  <div class="container">
    ...
    <div style="text-align:center; margin-top:32px">
      <a href="booking.html" class="btn btn-primary">새 상담 예약하기</a>
    </div>
  </div>
</section>
...
function initRevealObserver() {
  ...
  // 같은 부모 안에서 순서대로 살짝씩 딜레이를 줘서 순차적으로 나타나게 함
